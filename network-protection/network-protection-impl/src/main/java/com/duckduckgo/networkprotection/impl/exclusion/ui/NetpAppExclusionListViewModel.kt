...
class NetpAppExclusionListViewModel @Inject constructor(
    ...
    private fun refreshInstalledApps() {
        installedApps = packageManager.getInstalledApplications(PackageManager.GET_META_DATA).asSequence()
    }
    ...
    fun onAppProtectionChanged(app: NetpExclusionListApp, enabled: Boolean) {
        viewModelScope.launch {
            if (enabled) {
